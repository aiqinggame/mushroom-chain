...
BOOST_INCLUDE_PATH=D:/SDK/mushroom/boost_1_55_0
BOOST_LIB_PATH=D:/SDK/mushroom/boost_1_55_0/stage/lib
BDB_INCLUDE_PATH=D:/SDK/mushroom/db-4.8.30.NC/build_unix
BDB_LIB_PATH=D:/SDK/mushroom/db-4.8.30.NC/build_unix
OPENSSL_INCLUDE_PATH=D:/SDK/mushroom/openssl-1.0.1u/include
OPENSSL_LIB_PATH=D:/SDK/mushroom/openssl-1.0.1u
MINIUPNPC_LIB_PATH=D:/SDK/mushroom/miniupnpc-1.8/miniupnpc
MINIUPNPC_INCLUDE_PATH=D:/SDK/mushroom/miniupnpc-1.8

QRENCODE_INCLUDE_PATH=D:/SDK/mushroom/qrencode-3.4.3
QRENCODE_LIB_PATH=D:/SDK/mushroom/qrencode-3.4.3/.libs
...
LIBS += $$PWD/src/secp256k1/src/libsecp256k1_la-secp256k1.o
   ...
   isEmpty(SECP256K1_LIB_PATH) {
         windows:SECP256K1_LIB_PATH=D:/SDK/mushroom/secp256k1\.libs
   }
   isEmpty(SECP256K1_INCLUDE_PATH) {
       windows:SECP256K1_INCLUDE_PATH=D:/SDK/mushroom/secp256k1\include
   }
}
...
LIBS += $$join(BOOST_LIB_PATH,,-L,) $$join(BDB_LIB_PATH,,-L,) $$join(OPENSSL_LIB_PATH,,-L,) $$join(QRENCODE_LIB_PATH,,-L,) -LD:\SDK\mushroom\icu\lib
