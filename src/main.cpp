...
const string strMessageMagic = "MushroomChain Signed Message:\n";
...
bool ProcessMessages(CNode* pfrom)
{
    ...
    while (!pfrom->fDisconnect && it != pfrom->vRecvMsg.end()) {
        ...
        //if (fDebug)
//            LogPrintf("ProcessMessages(message %u msgsz, %zu bytes, complete:%s, cmd: %s)\n",
...
{
    int64_t ret = blockValue * 5/5; //100%
