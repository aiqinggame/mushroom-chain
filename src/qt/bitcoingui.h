...
private:
    ...
    QMenuBar *appMenuBar;
    QToolButton *overviewToolButton;
    QToolButton *historyToolButton;
    QAction *englishAction;
    QAction *cnZhAction;
    QAction *quitAction;
    QToolButton *sendCoinsToolButton;
    QToolButton *addressBookToolButton;
    QAction *signMessageAction;
    QAction *verifyMessageAction;
    QAction *multisigAction;
    QAction *aboutAction;
    QToolButton *receiveCoinsToolButton;
    ...
    QToolButton *masternodeManagerToolButton;
