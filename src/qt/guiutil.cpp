...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "MushroomChain.lnk";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("MushroomChain-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  MushroomChain-Qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("MushroomChain-Qt"));
